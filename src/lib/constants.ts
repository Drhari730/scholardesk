...
export const THESIS_STATUSES = [
  ...
  { value: "PROPOSAL", label: "Proposal / Synopsis", color: "bg-violet-100 text-violet-700" },
  { value: "LITERATURE_REVIEW", label: "Literature Review", color: "bg-purple-100 text-purple-700" },
  { value: "ETHICS_APPROVAL", label: "Ethics / IEC Approval", color: "bg-fuchsia-100 text-fuchsia-700" },
  { value: "DATA_COLLECTION", label: "Data Collection", color: "bg-cyan-100 text-cyan-700" },
  { value: "DATA_ANALYSIS", label: "Data Analysis", color: "bg-sky-100 text-sky-700" },
  { value: "WRITING", label: "Thesis Writing", color: "bg-amber-100 text-amber-700" },
  { value: "SUBMITTED", label: "Submitted", color: "bg-indigo-100 text-indigo-700" },
  { value: "REVISION", label: "Revision", color: "bg-orange-100 text-orange-700" },
  { value: "VIVA", label: "Viva / Defense", color: "bg-teal-100 text-teal-700" },
